...
class RBFManualCentroid(nn.Module):
    """
    ...
    def __init__(self, in_features, out_features, basis_func, device='cuda'):
        super(RBFManualCentroid, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        self.centres = torch.Tensor([[1., 1.],[-0.25, 2.5],[-1, 0.5]]).to(device)
